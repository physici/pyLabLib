...
class NIDAQ(IDevice):
    ...
    def _cfg_clock(self):
        if self.ai_task.ai_channels:
            self.ai_task.timing.cfg_samp_clk_timing(self.rate,source=self.clk_src or "",sample_mode=nidaqmx.constants.AcquisitionType.CONTINUOUS,samps_per_chan=int(self.buffer_size))
